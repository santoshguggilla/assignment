...
Data Flow
Controller
RequestMapping -- (/User/) List getAllProducts() -- Get All products details addOrders(List order) -- add order details Product getProductById(int id) -- get product details
